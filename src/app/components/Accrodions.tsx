  ...
  return (
    ...
    <div className=' md:grid grid-cols-2 gap-10'>
     ...
     <p className="text-[#22823A] font-semibold border-2 w-fit px-3 bg-gray-100 rounded-2xl py-1 my-5">
           ...
           <TextAnimate animation="blurInUp" by="character"   className=' text-2xl md:text-5xl font-bold mb-10'>
           Trading Accounts
                                       </TextAnimate>
    ...
    <Accordion defaultExpanded className='mb-5'>
      <AccordionSummary
        ...
        id="panel1-header"
      >
        <Typography component="span" className='font-semibold '>Who we are</Typography>
      </AccordionSummary>
      <AccordionDetails>
        <Typography>
    ...
    <Accordion className='mb-5'>
      <AccordionSummary
        ...
        id="panel2-header"
      >
        <Typography component="span" className='font-semibold '>What we do</Typography>
      </AccordionSummary>
      <AccordionDetails>
        <Typography>
    ...
    <Accordion className='mb-5' >
      <AccordionSummary
        ...
        id="panel2-header"
      >
        <Typography component="span" className='font-semibold '>How it works</Typography>
      </AccordionSummary>
      <AccordionDetails>
        <Typography>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
