...
const features = [
    "There will be 1-2 signals provided daily.",
"Maintaining a high level of accuracy on a monthly basis.",
"The Risk-to-Reward ratio is 1:1.5.",
"All recommendations will be provided with one target and one stop-loss.",
"Support and resistance levels for all major scripts are provided daily.",
"Updates on all major events and data impacting the Forex & Comex markets.",
...
"Access daily and weekly research reports via various platforms such as SMS, WhatsApp, Skype, Telegram, IMO, TeamViewer, and Voice."
  ];
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 max-w-7xl mx-auto gap-5 md:mb-20 mb-5">
        <div className="shadow-lg border rounded-lg md:py-5 md:px-10 p-5 bg-green-50 ">
          <div>
            ...
            <p className="md:text-3xl text-xl font-semibold py-5">$ 4000</p>
          </div>
        ...
        <div className="shadow-lg border rounded-lg md:py-5 md:px-10 p-5 bg-green-50">
          <div>
            ...
            <p className="md:text-3xl text-xl font-semibold py-5">$ 7000</p>
          </div>
          <Buttons name="Buy Now" />
        </div>
        <div className="shadow-lg border rounded-lg md:py-5 md:px-10 p-5 bg-green-50 ">
          <div>
            ...
            <p className="md:text-3xl text-xl font-semibold py-5">$ 10000</p>
          </div>
          <Buttons name="Buy Now" />
        </div>
        <div></div>
